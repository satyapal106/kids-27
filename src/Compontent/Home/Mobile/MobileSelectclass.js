        ...
        <div className='page-content'>
          <div className='contents'>
            ...
            <div className="row mt-4">
              <a href="/mobile-select-subject" className="col-6 p-0">
                <div
                  className="card card-style me-2 mb-3 gradient-red"
                ...
                >
                  ...
                  <div className="card-bottom">
                    <h4 className="color-white py-2 px-3">Grade I</h4>
                  </div>
                </div>
              </a>
              ...
              <a href="#" className="col-6 p-0">
                ...
                >
                  ...
                  <div className="card-bottom">
                    <h4 className="color-white py-2 px-3">Grade VIII</h4>
                  </div>
                </div>
              </a>
            </div>
